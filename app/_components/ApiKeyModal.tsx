  ...
  return (
    <div className="fixed inset-0 z-[60] bg-black/50 backdrop-blur-sm flex items-center justify-center p-6">
      <div className="bg-white rounded-[22px] shadow-2xl w-full max-w-md overflow-hidden">
        <div className="px-6 py-4 border-b border-[#E5E5EA]/40 bg-gradient-to-r from-[#007AFF]/5 to-[#5856D6]/5">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[11px] text-[#86868B]">Active les agents IA pour ce navigateur</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-6 space-y-4">
          ...
          <div>
            <input
              ...
              className="w-full text-[12px] p-3 border border-[#E5E5EA] rounded-[12px] outline-none focus:border-[#007AFF] focus:ring-2 focus:ring-[#007AFF]/20 font-mono"
            />
          ...
          {apiStatus === "error" && apiStatusReason && (
            <div className="text-[11px] text-[#FF3B30] bg-[#FF3B30]/5 border border-[#FF3B30]/15 rounded-[10px] p-2.5 max-h-[200px] overflow-y-auto">
        ...
        <div className="px-6 py-3.5 bg-[#fafafa] border-t border-[#E5E5EA]/40 flex items-center gap-2 flex-wrap">
          {hasUserApiKey() && (
