...
const navColors: Record<Tab, { bg: string; ring: string; text: string }> = {
  ...
  entretiens: { bg: "bg-[#FFE9DD]", ring: "ring-[#F2A77B]", text: "text-[#A04A0A]" },
...
export function Sidebar(props: Props) {
  ...
  return (
    <aside className="w-[280px] surface-elev border-r flex flex-col z-10" style={{ borderColor: "var(--mdec-border)" }}>
      {/* Header logo */}
