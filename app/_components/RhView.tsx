  ...
  return (
    <div className="flex-1 overflow-y-auto px-8 py-10">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Tabs internes */}
        <div className="flex gap-1.5 mb-4 bg-[#F5F5F7] p-1 rounded-[10px] inline-flex">
          {[
        ...
        {tab === "sophie" && (
          <div className="space-y-3">
            ...
            {/* Compte-rendu */}
            <div className="bg-white rounded-[18px] p-5 border border-[#E5E5EA]/40">
              <div className="flex items-center gap-2 mb-4">
                <FileText size={14} className="text-[#AF52DE]" />
                <span className="font-semibold text-[14px] text-[#1D1D1F]">Compte-rendu semaine · Jour {store.game_day}</span>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3 pb-3 border-b border-[#F5F5F7]">
                  ...
                  <div className="flex-1">
                    <div className="text-[12px] font-semibold text-[#1D1D1F]">Turnover</div>
                ...
                <div className="flex items-start gap-3 pb-3 border-b border-[#F5F5F7]">
                  ...
                  <div className="flex-1">
                    <div className="text-[12px] font-semibold text-[#1D1D1F]">Alertes en détresse</div>
                ...
                <div className="flex items-start gap-3 pb-3 border-b border-[#F5F5F7]">
                  <div className="text-[20px]">🎓</div>
                  <div className="flex-1">
                    <div className="text-[12px] font-semibold text-[#1D1D1F]">Formations</div>
                    <div className="text-[11px] text-[#86868B]">
                ...
                <div className="flex items-start gap-3 pb-3 border-b border-[#F5F5F7]">
                  <div className="text-[20px]">💰</div>
                  <div className="flex-1">
                    <div className="text-[12px] font-semibold text-[#1D1D1F]">Budget RH</div>
                    <div className="text-[11px] text-[#86868B]">
                ...
                <div className="flex items-start gap-3">
                  <div className="text-[20px]">📈</div>
                  <div className="flex-1">
                    <div className="text-[12px] font-semibold text-[#1D1D1F]">Recrutement</div>
                    <div className="text-[11px] text-[#86868B]">
        ...
        {tab === "cv" && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {candidats.map((c) => (
              <div key={c.id} className="bg-white rounded-[16px] p-4 border border-[#E5E5EA]/40 hover:shadow-md transition-all">
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="font-semibold text-[14px] text-[#1D1D1F]">{c.nom}</div>
                ...
                <div className="mt-2.5 pt-2.5 border-t border-[#F5F5F7] flex items-center justify-between text-[11px]">
                  <span className="text-[#86868B]">Salaire : <span className="font-semibold text-[#1D1D1F]">{(c.salaire_demande / 1000).toFixed(0)}k€</span></span>
        ...
        {tab === "recrutements" && (
          <div className="space-y-3">
            {recrutements.map((r) => (
              <div key={r.id} className="bg-white rounded-[16px] p-4 border border-[#E5E5EA]/40">
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-0.5 flex-wrap">
                      <span className="font-semibold text-[14px] text-[#1D1D1F]">{r.poste}</span>
                ...
                <div className="grid grid-cols-4 gap-2 text-[11px]">
                  <div className="bg-[#F5F5F7] rounded-[8px] p-2">
                    ...
                    <div className="text-[12px] font-semibold text-[#1D1D1F]">{(r.budget / 1000).toFixed(0)}k€</div>
                  </div>
                  <div className="bg-[#F5F5F7] rounded-[8px] p-2">
                    <div className="text-[#86868B] text-[9px]">CV reçus</div>
                    <div className="text-[12px] font-semibold text-[#1D1D1F]">{r.candidats_recus}</div>
                  </div>
                  <div className="bg-[#F5F5F7] rounded-[8px] p-2">
                    <div className="text-[#86868B] text-[9px]">Entretiens</div>
                    <div className="text-[12px] font-semibold text-[#1D1D1F]">{r.entretiens_planifies}</div>
                  </div>
                  <div className="bg-[#F5F5F7] rounded-[8px] p-2">
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="bg-white rounded-[22px] shadow-2xl w-full max-w-xl max-h-[92vh] overflow-hidden flex flex-col">
        <div className="px-6 py-4 border-b border-[#E5E5EA]/40 bg-gradient-to-r from-[#AF52DE]/5 to-[#5856D6]/5 flex items-center justify-between">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2 text-[12px]">
              <div className="bg-[#F5F5F7] rounded-[10px] p-2.5">
                ...
                <div className="font-semibold text-[#1D1D1F]">{c.trait_dominant}</div>
              </div>
              <div className="bg-[#F5F5F7] rounded-[10px] p-2.5">
                <div className="text-[#86868B] text-[9px] uppercase">Filière</div>
                <div className="font-semibold text-[#1D1D1F]">{c.filiere}</div>
              </div>
              <div className="bg-[#F5F5F7] rounded-[10px] p-2.5">
                <div className="text-[#86868B] text-[9px] uppercase">Salaire demandé</div>
                <div className="font-semibold text-[#1D1D1F]">{(c.salaire_demande / 1000).toFixed(0)}k€/an</div>
              </div>
              <div className="bg-[#F5F5F7] rounded-[10px] p-2.5">
                <div className="text-[#86868B] text-[9px] uppercase">Disponibilité</div>
                <div className="font-semibold text-[#1D1D1F]">{c.disponibilite}</div>
              </div>
            </div>
          </div>
